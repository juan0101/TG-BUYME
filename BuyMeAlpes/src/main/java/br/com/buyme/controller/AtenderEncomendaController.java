...
public class AtenderEncomendaController {
    ...
    @FXML private TableColumn<ProdutoPronto, String> cDFabricacaoEstoque;
    @FXML private TableColumn<ProdutoPronto, String> cDValidadeEstoque;
    ...
    @FXML private TableColumn<ProdutoPronto, String> cDFabricacaoEncomenda;
    @FXML private TableColumn<ProdutoPronto, String> cDValidadeEncomenda;
    		...
    		if(encomendas != null){
		      ...
		      //ALIMENTANDO TABELA DE ESTOQUE
    			...
    			cDFabricacaoEstoque.setCellValueFactory(
		            new PropertyValueFactory<ProdutoPronto,String>("dataFabricacaoStr")
		        );
    			cDValidadeEstoque.setCellValueFactory(
		            new PropertyValueFactory<ProdutoPronto,String>("dataValidadeStr")
		        );
