...
public class UsuarioDAO {
	...
	public void editarUsuario(int id, String login, String nome, String telefone, String endereco, int numero, String cidade, String email, boolean admin, List<PermissoesEnum> permissoes){
		EntityManager em = getEM();
		...
		try{
			...
			usuarioEditado.setPermissoes(permissoes);
			em.getTransaction().commit();
		}catch(Exception e){
			e.printStackTrace();
			em.getTransaction().rollback();
