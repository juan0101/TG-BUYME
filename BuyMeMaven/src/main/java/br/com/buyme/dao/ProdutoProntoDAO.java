...
public class ProdutoProntoDAO {
	...
	public void salvar(int codigo, String descricao, Date data_fabricacao, Date data_validade, int quantidade){
	 ...
	 * @param quantidade
	 */
	public void removerQuantidadeById(int id, int quantidade){
		try{
			EntityManager em = getEM();
			ProdutoPronto pp = em.find(ProdutoPronto.class, id);
			try{
